...
class So100DualCameraDataConfig(BaseDataConfig):
    video_keys = ["video.right", "video.top"]
    state_keys = [
        "state.single_arm",
        "state.gripper",
    ]
...
class So100ThreeCameraDataConfig(BaseDataConfig):
    video_keys = ["video.right", "video.top", "video.wrist"]
    state_keys = [
        "state.single_arm",
        "state.gripper",
    ]
...
class So100WristTopCameraDataConfig(BaseDataConfig):
...
DATA_CONFIG_MAP = {
    ...
    "so100_dual_camera": So100DualCameraDataConfig(),
    "so100_wrist_top_camera": So100WristTopCameraDataConfig(),
    "so100_three_camera": So100ThreeCameraDataConfig(),
}
